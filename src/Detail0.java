...
public class Detail0 extends JFrame {
	...
	public void setDataSearch(City city) {
		...
		if(city.getStatus() == "Mây cụm") {
			jLabelImageSearch.setIcon(setIconSearch("image\\maycum.png"));
		} else if (city.getStatus() == "Mây rải rác") {
			jLabelImageSearch.setIcon(setIconSearch("image\\mayrairac.png"));
		} else if (city.getStatus() == "Mưa vừa") {
			jLabelImageSearch.setIcon(setIconSearch("image\\muavua.png"));
		} else if (city.getStatus() == "Mưa cường độ nặng") {
			jLabelImageSearch.setIcon(setIconSearch("image\\muacuongdonang.png"));
		} else if (city.getStatus().equalsIgnoreCase("Nhiều mây")) {
			jLabelImageSearch.setIcon(setIconSearch("image\\nhieumay.png"));
		} else if (city.getStatus().equalsIgnoreCase("Sương mờ")) {
			jLabelImageSearch.setIcon(setIconSearch("image\\suongmo.png"));
		}
	}
